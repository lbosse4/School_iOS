...
protocol StatsHistoryDataSourceCellConfigurer {
    func configureCell(cell:StatsHistoryTableViewCell, withObject object:NSManagedObject) -> Void
...
class StatsHistoryDataSource : NSObject, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    var delegate : StatsHistoryDataSourceCellConfigurer?
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath: indexPath) as! StatsHistoryTableViewCell
