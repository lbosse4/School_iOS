...
protocol GameStatsDataSourceCellConfigurer {
    func configureCell(cell:GameStatsTableViewCell, withObject object:NSManagedObject) -> Void
    func cellIdentifierForObject(object: NSManagedObject) -> String
}

class GameStatsDataSource : NSObject, UITableViewDataSource, NSFetchedResultsControllerDelegate {
    ...
    var delegate : GameStatsDataSourceCellConfigurer?
    ...
    func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
        ...
        let cell = tableView.dequeueReusableCellWithIdentifier(cellIdentifier, forIndexPath: indexPath) as! GameStatsTableViewCell
    ...
    */
    ...
    func controller(controller: NSFetchedResultsController, didChangeObject anObject: AnyObject, atIndexPath indexPath: NSIndexPath?, forChangeType type: NSFetchedResultsChangeType, newIndexPath: NSIndexPath?) {
        ...
        case .Update:
            ...
            delegate?.configureCell(tableView.cellForRowAtIndexPath(indexPath!)! as! GameStatsTableViewCell, withObject: object)
        case .Move:
            tableView.deleteRowsAtIndexPaths([indexPath!], withRowAnimation: .Fade)
            tableView.insertRowsAtIndexPaths([newIndexPath!], withRowAnimation: .Fade)
